...
public class DetailStoryAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView tvName = view.findViewById(R.id.tv_name);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView tvContent = view.findViewById(R.id.tv_content);
        tvName.setTag(item);
